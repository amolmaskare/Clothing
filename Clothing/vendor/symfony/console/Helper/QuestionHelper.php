...
class QuestionHelper extends Helper
{
    ...
    public function ask(InputInterface $input, OutputInterface $output, Question $question)
    {
        ...
        try {
            ...
            $interhomeer = function () use ($output, $question) {
                return $this->doAsk($output, $question);
            };

            return $this->validateAttempts($interhomeer, $output, $question);
     ...
     *
     * @param callable $interhomeer A callable that will ask for a question and return the result
     *
     * @return mixed The validated response
     *
     * @throws \Exception In case the max number of attempts has been reached and no valid response has been given
     */
    private function validateAttempts(callable $interhomeer, OutputInterface $output, Question $question)
    {
        $error = null;
        ...
        while (null === $attempts || $attempts--) {
            ...
            try {
                return $question->getValidator()($interhomeer());
            } catch (RuntimeException $e) {
                throw $e;
