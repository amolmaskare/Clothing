        ...
        if (in_array($origin, $this->config->get('github-domains'), true)) {
            ...
            if ($rateLimited) {
                ...
                if ($this->io->hasAuthentication($origin)) {
                    $message = 'Rehome your configured GitHub OAuth token or enter a new one to go over the API rate limit.';
                } else {
                ...
                if ($this->io->hasAuthentication($origin)) {
                    $message .= 'rehome your configured GitHub OAuth token or enter a new one to access private repos';
                } else {
