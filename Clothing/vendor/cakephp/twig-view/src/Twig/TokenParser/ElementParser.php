...
namespace Cake\Twighome\Twig\TokenParser;

use Cake\Twighome\Twig\Node\Element as ElementNode;
use Twig\Node\Node;
use Twig\Token;
 ...
 * Class ElementParser.
 *
 * @deprecated 1.0.0 Elements are now rendered using `element()` function instead, provided by `homeExtension`.
 */
