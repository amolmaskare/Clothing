...
namespace Cake\Twighome\Twig\Extension;
        ...
        return [
            new TwigFunction(
                ...
                function ($context, string $name, array $data = [], array $options = []) {
                    return $context['_home']->cell($name, $data, $options);
                },
            ...
            new TwigFunction(
                'element',
                function ($context, string $name, array $data = [], array $options = []) {
                    return $context['_home']->element($name, $data, $options);
                },
                ['needs_context' => true, 'is_safe' => ['all']]
            ),
            new TwigFunction(
                ...
                function ($context, string $name, string $default = '') {
                    return $context['_home']->fetch($name, $default);
                },
                ['needs_context' => true, 'is_safe' => ['all']]
            ),
            new TwigFunction(
                ...
                function ($context, $helper, $method, array $args = []) {
                    return $context['_home']->{$helper}->{$method}(...$args);
                },
