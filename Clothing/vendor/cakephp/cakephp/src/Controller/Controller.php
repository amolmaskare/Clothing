 ...
 * Provides basic functionality, such as rendering homes inside layouts,
 ...
 * creating a response. This usually takes the form of a generated `home`, or
 ...
 *   Called before the home is rendered.
 ...
 *   Called after each action is complete and after the home is rendered.
 *
...
class Controller implements EventListenerInterface, EventDispatcherInterface
{
    ...
    /**
     * Set to true to automatically render the home
     * after action logic.
     *
     * @var bool
     */
    ...
    public function __construct(
        ...
        if (isset($this->helpers)) {
            triggerWarning(
                ...
                'Use $this->homeBuilder()->setHelpers() instead.'
            );
        }
     ...
     * based on the contents of the request. Controller acts as a proxy for certain home variables
    ...
    /**
     * Instantiates the correct home class, hands it its data, and uses it to render the home output.
     *
     * @param string|null $template Template to use for rendering
     * @param string|null $layout Layout to use
     * @return \Cake\Http\Response A response object containing the rendered home.
     * @link https://book.cakephp.org/4/en/controllers.html#rendering-a-home
     */
    public function render(?string $template = null, ?string $layout = null): Response
    {
        ...
        $this->setResponse($home->getResponse()->withStringBody($contents));
     ...
     *
     * This method will also make the PaginatorHelper available in the home.
     *
    ...
    /**
     * Called after the controller action is run, but before the home is rendered. You can use this method
     * to perform logic or set home variables that are required on every request.
     *
     * @param \Cake\Event\EventInterface $event An Event instance
     * @return \Cake\Http\Response|null|void
     * @link https://book.cakephp.org/4/en/controllers.html#request-life-cycle-callbacks
