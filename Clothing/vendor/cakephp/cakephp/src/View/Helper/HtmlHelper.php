 ...
 * @link https://book.cakephp.org/4/en/homes/helpers/html.html
 */
class HtmlHelper extends Helper
{
     ...
     * ```
     *
     * Append the meta tag to custom home block "meta":
     *
     * ```
     * $this->Html->meta('description', 'A great page', ['block' => true]);
     * ```
     *
     * Append the meta tag to custom home block:
     *
     * ```
     ...
     * ### Options
     *
     * - `block` - Set to true to append output to home block "meta" or provide
     *   custom block name.
     *
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/html.html#creating-meta-tags
     */
    public function meta($type, $content = null, array $options = []): ?string
    {
        if (!is_array($type)) {
            $types = [
                ...
                'homeport' => ['name' => 'homeport', 'content' => $content],
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/html.html#creating-charset-tags
     */
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/html.html#creating-links
     */
     ...
     * @link https://book.cakephp.org/3/en/homes/helpers/html.html#creating-links
     */
     ...
     * ```
     *
     * Add the stylesheet to home block "css":
     *
     * ```
     ...
     * ### Options
     *
     * - `block` Set to true to append output to home block "css" or provide
     *   custom block name.
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/html.html#linking-to-css-files
     */
     ...
     * ### Options
     *
     * - `block` Set to true to append output to home block "script" or provide
     *   custom block name.
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/html.html#linking-to-javascript-files
     */
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/html.html#creating-inline-javascript-blocks
     */
     ...
     * Generates a script tag inline or appends to specified home block depending on
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/html.html#creating-css-programatically
     */
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/html.html#linking-to-images
     */
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/html.html#creating-table-headings
     */
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/html.html#creating-table-cells
     */
    ...
    public function media($path, array $options = []): string
    {
        ...
        if (is_array($path)) {
            ...
            foreach ($path as &$source) {
                ...
                if (!isset($source['type'])) {
                    ...
                    $source['type'] = $this->_home->getResponse()->getMimeType($ext);
                }
        ...
        if ($tag === null) {
            if (is_array($path)) {
                ...
                /** @var string $mimeType */
                $mimeType = $this->_home->getResponse()->getMimeType(pathinfo($path, PATHINFO_EXTENSION));
            }
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/html.html#creating-nested-lists
     */
     ...
     * @see \Cake\home\Helper\HtmlHelper::nestedList()
     */
