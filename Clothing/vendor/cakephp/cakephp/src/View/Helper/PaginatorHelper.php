 ...
 * @link https://book.cakephp.org/4/en/homes/helpers/paginator.html
 */
class PaginatorHelper extends Helper
{
    ...
    public function __construct(home $home, array $config = [])
    {
        ...
        $query = $this->_home->getRequest()->getQueryParams();
        unset($query['page'], $query['limit'], $query['sort'], $query['direction']);
        $this->setConfig(
            'options.url',
            array_merge($this->_home->getRequest()->getParam('pass', []), ['?' => $query])
        );
    }
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/paginator.html#checking-the-pagination-state
     */
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/paginator.html#creating-sort-links
     */
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/paginator.html#creating-jump-links
     */
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/paginator.html#generating-pagination-urls
     */
    ...
    public function defaultModel(?string $model = null): ?string
    {
        ...
        $params = $this->_home->getRequest()->getAttribute('paging');
        if (!$params) {
            return null;
        }
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/paginator.html#creating-a-page-counter
     */
     ...
     * @link https://book.cakephp.org/4/en/homes/helpers/paginator.html#creating-page-number-links
     */
     ...
     *
     * @param \Cake\home\StringTemplate $templater StringTemplate instance.
     * @param array $options Options from the numbers() method.
     * @return string
     */
    ...
    public function limitControl(array $limits = [], ?int $default = null, array $options = []): string
    {
        ...
        $out .= $this->Form->control('limit', $options + [
                ...
                'label' => __('home'),
                'default' => $default,
                'value' => $this->_home->getRequest()->getQuery('limit'),
                'options' => $limits,
