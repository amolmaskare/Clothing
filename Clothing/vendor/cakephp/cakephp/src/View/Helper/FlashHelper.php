 ...
 * this class to output your flash messages in your homes.
 */
class FlashHelper extends Helper
{
     ...
     * to consolidate all the parameters for a given type of flash message into the home.
     *
     * ```
     ...
     * element.
     *
     * @param string $key The [Flash.]key you are rendering in the home.
    ...
    {
        $messages = $this->_home->getRequest()->getFlash()->consume($key);
        if ($messages === null) {
            return null;
        }
        ...
        foreach ($messages as $message) {
            ...
            $out .= $this->_home->element($message['element'], $message);
        }
