...
use Cake\home\Exception\MissingCellTemplateException;
...
abstract class Cell implements EventDispatcherInterface
{
    ...
    /**
     * Instance of the home created during rendering. Won't be set until after
     ...
     * @throws \Cake\home\Exception\MissingCellTemplateException
    ...
    public function render(?string $template = null): string
    {
        ...
        $render = function () use ($template) {
            ...
            try {
                return $home->render($template, false);
     ...
     *
     * *Note* This method will trigger an error when home rendering has a problem.
