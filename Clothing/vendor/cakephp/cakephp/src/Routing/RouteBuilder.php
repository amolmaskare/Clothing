...
class RouteBuilder
{
    ...
    protected static $_resourceMap = [
        ...
        'home' => ['action' => 'home', 'method' => 'GET', 'path' => ':id'],
     ...
     *
     * ```
     * $routes->redirect('/home/*', ['controller' => 'Posts', 'action' => 'home']);
     * ```
     *
     * Redirects /home/* to /posts/home and passes the parameters to /posts/home. Using an array as the
