...
trait ConventionsTrait
{
    ...
    /**
     * Creates the singular name for use in homes.
     *
    ...
    /**
     * Creates the plural variable name for homes
     *
     * @param string $name Name to use
     * @return string Plural name for homes
     */
    ...
    /**
     * Creates the singular human name used in homes
     *
    ...
    /**
     * Creates the plural human name used in homes
     *
     * @param string $name Controller name
