...
$this->assign('title', 'Missing home');
$this->assign('templateName', 'missing_home.php');
...
<p class="error">
    ...
    <?= sprintf('Create the class <em>%s</em> below in file: %s', h($class), $filePath . 'home' . DIRECTORY_SEPARATOR . h($class) . '.php'); ?>
</p>
<?php
$code = <<<PHP
<?php
