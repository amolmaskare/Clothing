...
/**
 * Represents the result of a prehome for a given mailer
 */
class PrehomeResult extends AbstractResult
{
    /**
    ...
    {
        if (!$mailer->homeBuilder()->getTemplate()) {
            $mailer->homeBuilder()->setTemplate($method);
        }
