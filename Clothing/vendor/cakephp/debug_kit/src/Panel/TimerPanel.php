    ...
    public function implementedEvents(): array
    {
        ...
        return [
            ...
            'Controller.beforeRender' => [
                ...
                ['priority' => 999, 'callable' => function () {
                    DebugMemory::record('home Render start');
                    DebugTimer::start('home: Render');
                }],
            ],
            'home.beforeRender' => $both('home.beforeRender'),
            'home.afterRender' => $both('home.afterRender'),
            'home.beforeLayout' => $both('home.beforeLayout'),
            'home.afterLayout' => $both('home.afterLayout'),
            'home.beforeRenderFile' => [
                ['priority' => 0, 'callable' => function ($event, $filename) {
                    DebugTimer::start('Render File: ' . $filename);
                }],
            ],
            'home.afterRenderFile' => [
                ['priority' => 0, 'callable' => function ($event, $filename) {
