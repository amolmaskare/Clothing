<p class="info">
    <?= __d('debug_kit',
            ...
            $this->Html->link(__d('debug_kit', 'Email prehomes page'), ['controller' => 'MailPrehome', 'action' => 'index'], ['target' => '_blank'])) ?>
</p>
<?php
    if (empty($emails)) {
    ...
    $url = $this->Url->build(['controller' => 'MailPrehome', 'action' => 'sent', 'panel' => $panel->id, 'id' => 0]);
?>
