...
* **Variables** Affiche les variables de home définies dans le controller.
...
.. only:: html or epub
  ...
  .. video:: ../_static/img/mail-prehomeer.gif
    :alt: Video du panneau Mail en action.
...
Chaque panneau s'attend à avoir un element de home qui rend le contenu du
