...
class BakeHelper extends Helper
{
    ...
    public function arrayProperty(string $name, array $value = [], array $options = []): string
    {
        ...
        return $this->_home->element('array_property', $options);
    }
    ...
    /**
     * Get fields data for home template.
     *
     * @param array $fields Fields list.
     * @param \Cake\Datasource\SchemaInterface $schema Schema instance.
     ...
     * @return array
     */
    public function gethomeFieldsData(array $fields, SchemaInterface $schema, array $associations): array
    {
