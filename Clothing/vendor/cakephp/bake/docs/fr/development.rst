...
Comme une classe de vue, ``Bakehome`` envoie les mêmes events que toute autre
...
"home.", ``Bakehome`` utilise le préfixe d'event "Bake.".
...
variables utilisées dans les templates de bake::
    ...
    EventManager::instance()->on('Bake.beforeRender', function (Event $event) {
        ...
        // Utilise $theOne pour les principales variable de données dans les home/edit
...
``Bakehome`` intègre les balises suivantes:
...
.. meta::
    ...
    :keywords lang=fr: interface ligne de commande,development,bake home, bake template syntax,erb tags,asp tags,percent tags
