...
behaviors, homes, helpers, controllers, components, test cases, fixtures
...
Cake/Twighome com seu bootstrap. Você também pode omiti-lo completamente,
o que faz com que o plugin Bake carregue esse plugin sob demanda.

.. meta::
    :title lang=pt: Bake Console
    :keywords lang=pt: cli,linha de comando,command line,dev,desenvolvimento,bake home, bake syntax,erb tags,asp tags,percent tags
