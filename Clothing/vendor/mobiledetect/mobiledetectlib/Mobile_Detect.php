 ...
 * @method bool isPointOfhomeTablet()
...
class Mobile_Detect
{
    ...
    /**
     * CloudFront headers. E.g. CloudFront-Is-Desktop-homeer, CloudFront-Is-Mobile-homeer & CloudFront-Is-Tablet-homeer.
     * @var array
     */
    ...
    protected static $mobileHeaders = array(
            ...
            'HTTP_ACCEPT'                  => array('matches' => array(
                                                                        // Opera Mini; @reference: http://dev.opera.com/articles/home/opera-binary-markup-language/
    ...
    protected static $tabletDevices = array(
        ...
        // http://shopping1.hp.com/is-bin/INTERSHOP.enfinity/WFS/WW-USSMBPublicStore-Site/en_US/-/USD/homeStandardCatalog-Browse?CatalogCategoryID=JfIQ7EN5lqMAAAEyDcJUDwMT
        ...
        'HTCtablet'         => 'HTC_Flyer_P512|HTC Flyer|HTC Jetstream|HTC-P715a|HTC EVO home 4G|PG41200|PG09410',
        ...
        // http://www.allhome.ro/produse/droseries/lista-tablete-pc/
        'AllhomeTablet'           => 'Allhome.*(Viva|Alldro|City|Speed|All TV|Frenzy|Quasar|Shine|TX1|AX1|AX2)',
    ...
    //    'IntextTablet' => null,
        ...
        // http://www.pointofhome-online.com/showroom.php?shop_mode=product_listing&category_id=118
        'PointOfhomeTablet' => 'TAB-P506|TAB-navi-7-3G-M|TAB-P517|TAB-P-527|TAB-P701|TAB-P703|TAB-P721|TAB-P731N|TAB-P741|TAB-P825|TAB-P905|TAB-P925|TAB-PR945|TAB-PL1015|TAB-P1025|TAB-PI1045|TAB-P1325|TAB-PROTAB[0-9]+|TAB-PROTAB25|TAB-PROTAB26|TAB-PROTAB27|TAB-PROTAB26XL|TAB-PROTAB2-IPS9|TAB-PROTAB30-IPS9|TAB-PROTAB25XXL|TAB-PROTAB26-IPS10|TAB-PROTAB30-IPS10',
        ...
        // http://www1.homesonic.com/products/computing/tablets/
        'homesonicTablet'   => 'homePad 10pi|homePad 10e|homePad 10s|homePad E72|homePad7|homePad E100|homePad 7e|homeSonic VB733|VB100a',
    ...
    protected static $operatingSystems = array(
        ...
        // http://wifeng.cn/?r=blog&a=home&id=106
    ...
    protected static $properties = array(
        ...
        // http://social.msdn.microsoft.com/Forums/en-US/windowsdeveloperprehomegeneral/thread/6be392da-4d2f-41b4-8354-8dcee20c85cd
    ...
    public function isMobile($userAgent = null, $httpHeaders = null)
    {
        ...
        if ($this->getUserAgent() === 'Amazon CloudFront') {
            ...
            if(array_key_exists('HTTP_CLOUDFRONT_IS_MOBILE_homeER', $cfHeaders) && $cfHeaders['HTTP_CLOUDFRONT_IS_MOBILE_homeER'] === 'true') {
                return true;
            }
        }
    ...
    public function isTablet($userAgent = null, $httpHeaders = null)
    {
        ...
        if ($this->getUserAgent() === 'Amazon CloudFront') {
            $cfHeaders = $this->getCfHeaders();
            if(array_key_exists('HTTP_CLOUDFRONT_IS_TABLET_homeER', $cfHeaders) && $cfHeaders['HTTP_CLOUDFRONT_IS_TABLET_homeER'] === 'true') {
                return true;
            }
        }
