...
* [Magento helper](http://www.magentocommerce.com/magento-connect/catalog/product/home/id/16835/) from Optimise Web enables 
...
Mobile-Detect features (Mobile_Detect class as a service, helper for homes and plugin controllers). 
...
Appropriate home helper and controller plugin also have different conceptions. 
Made by [Nikola Posa](https://github.com/nikolaposa).

**Symfony**

* [Symfony3 MobileDetectBundle](https://github.com/tattali/MobileDetectBundle) is a Symfony bundle to detect mobile devices, manage mobile home and redirect to the mobile and tablet version. Made by [Théo Attali](https://github.com/tattali).

* [Symfony2 Mobile Detect Bundle](https://github.com/suncat2000/MobileDetectBundle) is a bundle for detecting mobile devices, 
manage mobile home and redirect to the mobile and tablet version.
...
* [px_mobiledetect](https://typo3.org/extensions/repository/home/px_mobiledetect) is an extension that helps to detect 
