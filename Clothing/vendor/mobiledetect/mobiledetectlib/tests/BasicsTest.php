...
class BasicTest extends TestCase
{
    ...
    public function testSetCfHeaders()
    {
        ...
        $header1 = array(
            'HTTP_CLOUDFRONT_IS_DESKTOP_homeER' => 'false',
            'HTTP_CLOUDFRONT_IS_MOBILE_homeER'  => 'true',
            'HTTP_CLOUDFRONT_IS_TABLET_homeER'  => 'false'
        );
        $md = new Mobile_Detect($header1);
        ...
        $header2 = array(
            'HTTP_CLOUDFRONT_IS_DESKTOP_homeER' => 'true',
            'HTTP_CLOUDFRONT_IS_MOBILE_homeER'  => 'false',
            'HTTP_CLOUDFRONT_IS_TABLET_homeER'  => 'false'
        );
        $md->setHttpHeaders($header2);
        ...
        $header3 = array(
            'HTTP_CLOUDFRONT_IS_DESKTOP_homeER' => 'false',
            'HTTP_CLOUDFRONT_IS_MOBILE_homeER'  => 'false',
            'HTTP_CLOUDFRONT_IS_TABLET_homeER'  => 'true'
        );
