...
<section id="advice">
  ...
  <ul>
    ...
    <li><b>Hosted on <a href="https://github.com/almasaeed2010/AdminLTE/" target="_blank">GitHub</a>.</b> Visit our GitHub repository to home issues, make requests, or contribute to the project.</li>
  </ul>
  <p>
...
&LT;script src="dist/js/app.js" type="text/javascript">&LT;/script></code></pre>
  ...
  //sidebar treehome slide up/down. This options accepts an integer as milliseconds,
  //'fast', 'normal', or 'slow'
  animationSpeed: 500,
  ...
  //Control Sidebar Tree homes
  enableControlTreehome: true,
...
<section id="components" data-spy="scroll" data-target="#scrollspy-components">
  ...
  <div class="callout callout-info lead">
    <h4>Reminder!</h4>
    <p>
      AdminLTE uses all of Bootstrap 3 components. It's a good start to rehome
        ...
        &LT;li class="dropdown notifications-menu">
          ...
          &LT;ul class="dropdown-menu">
            ...
            &LT;li>
              ...
              &LT;/ul>
            &LT;/li>
            &LT;li class="footer">&LT;a href="#">home all&LT;/a>&LT;/li>
          &LT;/ul>
        &LT;/li>
...
<section id="upgrade">
  ...
  <h3>Mailbox</h3>
  <p>Mailbox got an upgrade to include three different homes. The homes are inbox, read mail, and compose new email. To use these homes,
