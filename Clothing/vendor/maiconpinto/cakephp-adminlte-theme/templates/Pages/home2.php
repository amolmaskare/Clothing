  ...
  <div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-danger">
            ...
            <div class="box-footer text-center">
              <a href="javascript:void(0)" class="uppercase">home All Users</a>
            </div>
            <!-- /.box-footer -->
          </div>
          <!--/.box -->
      ...
      <div class="box box-info">
        ...
        <div class="box-footer clearfix">
          ...
          <a href="javascript:void(0)" class="btn btn-sm btn-default btn-flat pull-right">home All Orders</a>
        </div>
        <!-- /.box-footer -->
      </div>
      <!-- /.box -->
    ...
    <div class="col-md-4">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-body -->
        <div class="box-footer text-center">
          <a href="javascript:void(0)" class="uppercase">home All Products</a>
        </div>
        <!-- /.box-footer -->
      </div>
      <!-- /.box -->
