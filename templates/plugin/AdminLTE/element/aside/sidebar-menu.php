<ul class="sidebar-menu" data-widget="tree">
  ...
  <li class="treeview">
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-dashboard"></i> <span>Widths</span>
            <span class="pull-right-container">
        <i class="fa fa-angle-left pull-right"></i>
      </span>
        </a>
        <ul class="treeview-menu">
            <li><a href="<?php echo $this->Url->build('/widths/add'); ?>"><i class="fa fa-circle-o"></i> New Width</a></li>
            <li><a href="<?php echo $this->Url->build('/widths'); ?>"><i class="fa fa-circle-o"></i>List of Widths</a></li>
        </ul>
    </li>
