 ...
 * WidthsFixture
 */
class WidthsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'denier_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'pick_id' => 1,
                'denier_id' => 1,
                'created' => '2024-08-14 15:05:55',
                'modified' => '2024-08-14 15:05:55',
            ],
        ];
        parent::init();
    }
